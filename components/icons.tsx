...
export const MagicWandIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M19.41,9.58L17.5,7.67a1,1,0,0,0-1.42,0L13.17,10.5a1,1,0,0,0,0,1.42L15,13.83l-3.71,3.7-2.12-2.12a1,1,0,0,0-1.42,0L4.5,18.66a1,1,0,0,0,0,1.41l.92.92a1,1,0,0,0,1.41,0L10,17.83l3.71,3.7a1,1,0,0,0,1.42,0l2.83-2.83a1,1,0,0,0,0-1.42L15,14.41l1.92-1.92a1,1,0,0,0,0-1.41ZM22,2.83a1,1,0,0,0-1.41,0l-1,1L21.5,5.74l1-1a1,1,0,0,0,0-1.41Z M7,13.41l-1,1L7.92,16.34l1-1Z M3.26,16.74a1,1,0,0,0-1.42,0l-1,1a1,1,0,0,0,0,1.41l.92.92a1,1,0,0,0,1.41,0l1-1Z"/>
    </svg>
);
